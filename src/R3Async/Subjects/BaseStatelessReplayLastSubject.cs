...
public abstract class BaseStatelessReplayLastSubject<T>(Optional<T> startValue) : AsyncObservable<T>, ISubject<T>
{
    readonly Optional<T> _startValue = startValue;
    Optional<T> _value = startValue;
